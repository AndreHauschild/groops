...
inline GnssProcessingStepWriteResiduals::GnssProcessingStepWriteResiduals(Config &config)
{
  try
  {
    ...
    readConfig(config, "outputfileResidualsIsl",  fileNameResidualsIsl, Config::OPTIONAL, "output/residuals_{loopTime:%D}.{prn}.dat", "variable {prn} available");
  }
